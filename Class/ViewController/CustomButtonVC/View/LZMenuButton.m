...
-(void)tableView:(UITableView *)tableView willDisplayCell:(LZMenuButtonCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGAffineTransform translationTransform = CGAffineTransformMakeTranslation(0,-(indexPath.row+1)*CGRectGetHeight(cell.iconIV.frame));
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.iconIV.image = [UIImage imageNamed:[_imageArray objectAtIndex:indexPath.row]];
