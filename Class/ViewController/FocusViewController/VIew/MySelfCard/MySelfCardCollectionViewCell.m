...
-(void)setArray:(NSArray *)array{
    _array = array;
    YQSweepCardView *yqCaraview = [[YQSweepCardView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 200)];
    [self addSubview:yqCaraview];
    self.yqCaraview = yqCaraview;
    yqCaraview.backgroundColor = [UIColor whiteColor];
    ...
    self.pageControl = [[LWDPageControl alloc] initWithFrame:CGRectMake((SCREEN_WIDTH-200)/2, 200-30, 200, 30) indicatorMargin:10.f indicatorWidth:5.f currentIndicatorWidth:10.f indicatorHeight:5];
