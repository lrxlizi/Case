...
-(void)createUI{
    ...
    self.TopBgView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 250)];
    ...
    UIButton *closeBtn = [[UIButton alloc]initWithFrame:CGRectMake(SCREEN_WIDTH-60, 5, 40, 40)];
    [self.topView addSubview:closeBtn];
    [closeBtn setImage:[UIImage imageNamed:@"icon_popup_close"] forState:UIControlStateNormal];
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView{
    if (scrollView.tag ==self.tableView.tag) {
        ...
        if (height < 100) {
            ...
            self.TopBgView.frame = CGRectMake(0, 0, SCREEN_WIDTH, 350);
        }else{
